...
var editTask = function(){
  ...
  var editInput=listItem.querySelector(".tasks-group__task");
  var label=listItem.querySelector(".tasks-group__label");
  var editBtn=listItem.querySelector(".btn_edit");
  var containsClass=listItem.classList.contains("tasks-group__item_edit");
...
var deleteTask = function(){
  ...
  var listItem=this.parentNode;
  var taskGroup=listItem.parentNode;
